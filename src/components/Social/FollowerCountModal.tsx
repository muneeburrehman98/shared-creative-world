...
interface FollowerCountModalProps {
  userId: string;
...
export const FollowerCountModal = ({ userId, type, children }: FollowerCountModalProps) => {
        ...
        <CardContent className="p-4">
          <div className="flex items-center justify-between">
            <div 
              ...
              onClick={() => handleUserClick(item.profile!.username)}
            >
              <Avatar>
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className="max-w-md max-h-[80vh] overflow-hidden">
        ...
        <Tabs defaultValue={type} className="flex-1 overflow-hidden">
