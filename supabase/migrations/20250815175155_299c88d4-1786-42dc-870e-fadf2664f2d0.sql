...
DROP POLICY IF EXISTS "Users can view files in public projects" ON storage.objects;
...
DROP POLICY IF EXISTS "Project owners can upload files" ON storage.objects;
...
DROP POLICY IF EXISTS "Project owners can delete files" ON storage.objects;
